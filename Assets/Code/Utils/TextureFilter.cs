// Authors : andrewkirillov, anders9ustafsson, stefan-j, craigmillard
// Retrieved from http://www.aforgenet.com/framework/samples/
// Github Link : https://github.com/andrewkirillov/AForge.NET
...
public static class TextureFilter
{
    ...
    public static readonly float[][] EDGEDETECT_KERNEL_HORIZONTAL_TEST = new float[4][]
    {
        new float[4]{ -1, -1, -1, 0 },
        new float[4]{ 2, 2, 2, 0 },
        new float[4]{ 2, 2, 2, 0 },
    ...
    public static readonly float[][] EDGEDETECT_KERNEL_HORIZONTAL_TEST_2 = new float[5][]
    {
        new float[5]{ 0, -1, -1, -1, 0 },
        new float[5]{ 0, 2, 2, 2, 0 },
        new float[5]{ 0, 2, 2, 2, 0 },
        new float[5]{ 0, 2, 2, 2, 0 },
        new float[5]{ 0, -1, -1, -1, 0 }
    };
