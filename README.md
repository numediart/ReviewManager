# ReviewManager
Unity application to generate 3D models based on building maps &amp; receive, display and manage Reviews send with [ReviewApp](https://github.com/numediart/ReviewApp)
